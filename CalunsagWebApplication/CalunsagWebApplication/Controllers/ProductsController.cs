using CalunsagWebApplication.Data;
using CalunsagWebApplication.Models;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace CalunsagWebApplication.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult Create(ProductDto productDto)
        {
            ...
            {
                ModelState.AddModelError("ImageFile", "The image file is require!");
            }
