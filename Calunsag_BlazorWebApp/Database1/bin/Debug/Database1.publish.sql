...
RETURN 0
GO
PRINT N'Creating Procedure [dbo].[select]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '0259ff5a-a809-4934-8e52-ade0510dba12')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('0259ff5a-a809-4934-8e52-ade0510dba12')
